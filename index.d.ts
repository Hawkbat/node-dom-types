 ...
 * 
 * Node.js supports a subset of the File API (`webkitRelativePath` is not supported).
 *
...
declare var FormData: {
    ...
    /**
     * Node.js does not support passing an HTMLFormElement in the constructor.
     */
    new(): FormData;
};
 ...
 * 
 * Node.js supports a subset of the Navigator API.
 *
 ...
 * 
 * Node.js supports a subset of the Performance API.
 *
...
declare var URL: {
    ...
    /**
     * Node.js does not support passing a MediaSource as the first argument.
     * 
...
/**
 * The the timeout handle returned by `setTimeout` and `setInterval` is a number in the browser but a Node.js `Timeout` object in Node.js. For compatibility, treat handles as opaque values.
 * 
 * [MDN Reference](https://developer.mozilla.org/docs/Web/API/Window/clearInterval) */
declare function clearInterval(id: TimeoutHandle | undefined): void;

/**
 * The the timeout handle returned by `setTimeout` and `setInterval` is a number in the browser but a Node.js `Timeout` object in Node.js. For compatibility, treat handles as opaque values.
 * 
 * [MDN Reference](https://developer.mozilla.org/docs/Web/API/Window/clearTimeout) */
declare function clearTimeout(id: TimeoutHandle | undefined): void;
...
declare function setInterval(handler: TimerHandler, timeout?: number, ...arguments: any[]): TimeoutHandle;

/**
 * The the timeout handle returned by `setTimeout` and `setInterval` is a number in the browser but a Node.js `Timeout` object in Node.js. For compatibility, treat handles as opaque values.
 * 
 * [MDN Reference](https://developer.mozilla.org/docs/Web/API/Window/setTimeout) */
declare function setTimeout(handler: TimerHandler, timeout?: number, ...arguments: any[]): TimeoutHandle;
...
/**
 * This is a TypeScript hack to allow for treating the return type of `setTimeout` and `setInterval` as a unique type. Timeout handles are a number in the browser but a Node.js `Timeout` object in Node.js.
 */
declare const __TIMEOUT_HANDLE_BRAND_HACK: unique symbol;
/**
 * This is a TypeScript hack to allow for treating the return type of `setTimeout` and `setInterval` as a unique type. Timeout handles are a number in the browser but a Node.js `Timeout` object in Node.js.
 */
declare type TimeoutHandle = number & { [__TIMEOUT_HANDLE_BRAND_HACK]: never };
